...
const AccountStack = () => (
    <Stack.Navigator initialRouteName="My Account" screenOptions={screenOptionStyle} headerMode="screen">
        <Stack.Screen name="My Account" options={{ headerLeft: null }} component={AccountScreen} />
        <Stack.Screen name="Patient Demographics" component={PatientDemographicsScreen} />
        <Stack.Screen name="Coverage" component={CoverageScreen} />
        <Stack.Screen name="Benefits" options={{ headerShown: false }} component={BenefitsScreen} />
