...
class PatientDemographicsScreen extends Component {
    ...
    render() {
        const { birthSex, Gender, raceEthnicity, city, state, country, telecom } = this.state;
            ...
            <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: hp(10) }}>
                ...
                <View style={styles.singleItemContainer}>
                    ...
                    <DropDownPicker
                        ...
                        itemStyle={{ justifyContent: 'flex-start' }}
                        dropDownStyle={{ backgroundColor: '#fafafa' }}
                        onChangeItem={(item) => this.setState({ raceEthnicity: item.value })}
                    />
                </View>
                <View style={styles.singleItemContainer}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                        <DropDownPicker
                            ...
                            itemStyle={{ justifyContent: 'flex-start' }}
                            dropDownStyle={{ backgroundColor: '#fafafa' }}
                            onChangeItem={(item) => this.selectMonth(item, dateOfBirth, 'dateOfBirth')}
                        />
                        <DropDownPicker
                            items={days}
                            ...
                            itemStyle={{ justifyContent: 'flex-start' }}
                            dropDownStyle={{ backgroundColor: '#fafafa' }}
                            onChangeItem={(item) => this.selectDay(item, dateOfBirth, 'dateOfBirth')}
                        />
                        <DropDownPicker
                            items={years}
                            ...
                            itemStyle={{ justifyContent: 'flex-start' }}
                            dropDownStyle={{ backgroundColor: '#fafafa' }}
                            onChangeItem={(item) => this.selectYear(item, dateOfBirth, 'dateOfBirth')}
                        />
                    </View>
                </View>
                <View style={{ paddingTop: hp(2), paddingHorizontal: wp(6) }}>
                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#949494', }}>Home Address</Text>
                ...
                <View style={styles.singleItemContainer}>
                    ...
                    <DropDownPicker
                        items={[
                            ...
                            { label: 'Schurz Communications', value: 'Schurz Communications' },
